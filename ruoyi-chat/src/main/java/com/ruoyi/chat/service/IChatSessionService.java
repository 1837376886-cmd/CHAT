...
public interface IChatSessionService {
    ...
    void incrementUnreadCount(Long userId, String sessionId);
    
    Long getUnreadCount(Long userId, String sessionId);
    
    void clearUnreadCount(Long userId, String sessionId);
    
    List<ChatSession> getUserSessionsWithUnreadCount(Long userId);
}

...
import com.ruoyi.chat.service.impl.ChatSessionService;
...
public class ChatController extends BaseController {
    ...
    public AjaxResult getUserSessions() {
        ...
        List<ChatSession> sessions = chatSessionService.getUserSessionsWithUnreadCount(userId);
        ...
        if (session != null) {
            ...
            for (ChatSessionMember member : members) {
                if (!member.getUserId().equals(fromUserId)) {
                    chatSessionService.incrementUnreadCount(member.getUserId(), sessionId);
                }
            }
        }
    ...
    public TableDataInfo getSessionMessages(@PathVariable String sessionId,
        ...
        IPage<ChatMessage> result = chatMessageService.getSessionMessages(page, sessionId);
    ...
    public AjaxResult markMessageAsRead(@PathVariable String messageId) {
        ...
        if (message != null) {
            chatSessionService.clearUnreadCount(userId, message.getSessionId());
        }

package com.lytboot.chat.controller;

import com.lytboot.chat.domain.entity.ChatVisitor;
import com.lytboot.chat.domain.entity.CsConfig;
import com.lytboot.chat.domain.entity.CsMessage;
import com.lytboot.chat.domain.entity.CsSession;
...
public class CustomerServiceController {
    ...
    public AjaxResult csOffline() {
        ...
        for (CsSession session : activeSessions) {
            ...
            try {
                ...
                if (visitor != null) {
                    com.lytboot.chat.protocol.ChatMessage systemMsg = new com.lytboot.chat.protocol.ChatMessage(com.lytboot.chat.protocol.MessageType.SYSTEM_NOTICE);
    ...
    public AjaxResult acceptTransfer(@RequestBody Map<String, String> params) {
        ...
        // 4. 推送通知给原客服A
        com.lytboot.chat.protocol.ChatMessage acceptMsg = new com.lytboot.chat.protocol.ChatMessage(com.lytboot.chat.protocol.MessageType.CS_TRANSFER_ACCEPT);
        ...
        com.lytboot.chat.protocol.ChatMessage notice = new com.lytboot.chat.protocol.ChatMessage(com.lytboot.chat.protocol.MessageType.SYSTEM_NOTICE);
